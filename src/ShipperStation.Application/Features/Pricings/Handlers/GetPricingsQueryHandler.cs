...
internal sealed class GetPricingsQueryHandler(IUnitOfWork unitOfWork) : IRequestHandler<GetPricingsQuery, IList<PricingResponse>>
{
    ...
    {
        return await _pricingRepository.FindAsync<PricingResponse>(cancellationToken: cancellationToken);
    }
}
