...
internal sealed class GetPackagesForUserQueryHandler(
    IUnitOfWork unitOfWork,
    ICurrentUserService currentUserService) : IRequestHandler<GetPackagesForUserQuery, PaginatedResponse<PackageResponse>>
{
    private readonly IGenericRepository<Package> _packageRepository = unitOfWork.Repository<Package>();
    public async Task<PaginatedResponse<PackageResponse>> Handle(GetPackagesForUserQuery request, CancellationToken cancellationToken)
    {
