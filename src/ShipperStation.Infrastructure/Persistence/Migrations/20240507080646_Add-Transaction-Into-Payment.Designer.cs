...
namespace ShipperStation.Infrastructure.Migrations
{
    ...
    [Migration("20240507080646_Add-Transaction-Into-Payment")]
    partial class AddTransactionIntoPayment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("ShipperStation.Domain.Entities.Transaction", "Transaction")
                        .WithOne("Payment")
                        .HasForeignKey("ShipperStation.Domain.Entities.Payment", "TransactionId");
