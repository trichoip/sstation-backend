...
namespace ShipperStation.Infrastructure.Migrations
{
    ...
    [Migration("20231225231511_Update-Entity-Role")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ShipperStation.Domain.Entities.RoleClaim", b =>
                {
                    b.HasOne("ShipperStation.Domain.Entities.Role", null)
                        .WithMany()
